...
import { FaBath, FaShareAlt, FaBed, FaUserCircle, FaVideo, FaCamera, FaMapMarkerAlt, FaHeart, FaPlug, FaPlus } from 'react-icons/fa'
        ...
        <div id="grid-box" className='w-full grid lg:grid-cols-3 grid-cols-1 justify-center items-center gap-8'>
          {
            property.map((item, index)=>(
              <div key={index} data-aos="zoom-in" data-aos-delay="200" className='bg-white dark:bg-gray-800 rounded-xl w-full'>
                ...
                <div  data-aos="zoom-in"  data-aos-delay="300" className='px-6 py-3 flex flex-col justify-center items-start gap-2 w-full'>
